...
---------------------
This would change the way pod how pod manager registered into valence. It would change
from configuring it in config file before valence service started to adding it on the
frontend site or command api after valence service started.
